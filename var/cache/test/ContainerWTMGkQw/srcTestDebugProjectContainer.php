...
class srcTestDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            'App\\Controller\\ArticlesController' => 'getArticlesControllerService.php',
    ...
    {
        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer(array(0 => ($this->privates['fos_rest.serializer.form_error_normalizer'] ?? $this->getFosRest_Serializer_FormErrorNormalizerService()), 1 => ($this->privates['serializer.normalizer.json_serializable'] ?? $this->privates['serializer.normalizer.json_serializable'] = new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer()), 2 => ($this->privates['serializer.normalizer.datetime'] ?? $this->privates['serializer.normalizer.datetime'] = new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer()), 3 => ($this->privates['serializer.normalizer.constraint_violation_list'] ?? $this->privates['serializer.normalizer.constraint_violation_list'] = new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer()), 4 => ($this->privates['serializer.normalizer.dateinterval'] ?? $this->privates['serializer.normalizer.dateinterval'] = new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer()), 5 => ($this->privates['serializer.normalizer.data_uri'] ?? $this->privates['serializer.normalizer.data_uri'] = new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer()), 6 => ($this->privates['serializer.denormalizer.array'] ?? $this->privates['serializer.denormalizer.array'] = new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer()), 7 => ($this->privates['serializer.normalizer.object'] ?? $this->getSerializer_Normalizer_ObjectService())), array(0 => ($this->privates['serializer.encoder.xml'] ?? $this->privates['serializer.encoder.xml'] = new \Symfony\Component\Serializer\Encoder\XmlEncoder()), 1 => ($this->privates['serializer.encoder.json'] ?? $this->privates['serializer.encoder.json'] = new \Symfony\Component\Serializer\Encoder\JsonEncoder()), 2 => ($this->privates['serializer.encoder.yaml'] ?? $this->privates['serializer.encoder.yaml'] = new \Symfony\Component\Serializer\Encoder\YamlEncoder()), 3 => ($this->privates['serializer.encoder.csv'] ?? $this->privates['serializer.encoder.csv'] = new \Symfony\Component\Serializer\Encoder\CsvEncoder())));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig\Environment(($this->privates['twig.loader.native_filesystem'] ?? $this->getTwig_Loader_NativeFilesystemService()), array('paths' => array('/app/templates' => NULL), 'debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception::showAction', 'form_themes' => $this->parameters['twig.form.resources'], 'autoescape' => 'name', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'default_path' => '/app/templates', 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uvJ9E0wP8f', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('xw+Y6oICD-', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kkoN1YfJBW', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1usTfzeprz', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('G4sitxcZ7S', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IO-WkcJV5+', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    /**
     * Gets the private 'fos_rest.converter.request_body' shared service.
     *
     * @return \FOS\RestBundle\Request\RequestBodyParamConverter
     */
    protected function getFosRest_Converter_RequestBodyService()
    {
        return $this->privates['fos_rest.converter.request_body'] = new \FOS\RestBundle\Request\RequestBodyParamConverter(($this->privates['fos_rest.serializer.symfony'] ?? $this->getFosRest_Serializer_SymfonyService()), array(), '', ($this->services['validator'] ?? $this->getValidatorService()), 'validationErrors');
    }
    ...
    {
        return $this->privates['fos_rest.serializer.form_error_normalizer'] = new \FOS\RestBundle\Serializer\Normalizer\FormErrorNormalizer(($this->services['translator'] ?? $this->getTranslatorService()));
    }
    ...
    protected function getSensioFrameworkExtra_Converter_ManagerService()
    {
        ...
        $instance->add(($this->privates['fos_rest.converter.request_body'] ?? $this->getFosRest_Converter_RequestBodyService()), -50, 'fos_rest.request_body');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        })), ($this->privates['translator.formatter.default'] ?? $this->getTranslator_Formatter_DefaultService()), 'en', array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yaml', 1 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => ($this->targetDirs[0].'/translations'), 'debug' => true, 'resource_files' => array('af' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.af.xlf'), 'ar' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.ar.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.ar.xlf'), 'az' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.az.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.az.xlf'), 'bg' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.bg.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.bg.xlf'), 'ca' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.ca.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.ca.xlf'), 'cs' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.cs.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.cs.xlf'), 'cy' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.cy.xlf'), 'da' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.da.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.da.xlf'), 'de' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.de.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.de.xlf'), 'el' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.el.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.el.xlf'), 'en' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.en.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.en.xlf'), 'es' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.es.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.es.xlf'), 'et' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.et.xlf'), 'eu' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.eu.xlf'), 'fa' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.fa.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.fa.xlf'), 'fi' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.fi.xlf'), 'fr' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.fr.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.fr.xlf'), 'gl' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.gl.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.gl.xlf'), 'he' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.he.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.he.xlf'), 'hr' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.hr.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.hr.xlf'), 'hu' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.hu.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.hu.xlf'), 'hy' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.hy.xlf'), 'id' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.id.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.id.xlf'), 'it' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.it.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.it.xlf'), 'ja' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.ja.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.ja.xlf'), 'lb' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.lb.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.lb.xlf'), 'lt' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.lt.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.lt.xlf'), 'lv' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.lv.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.lv.xlf'), 'mn' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.mn.xlf'), 'nb' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.nb.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.nb.xlf'), 'nl' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.nl.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.nl.xlf'), 'nn' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.nn.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.nn.xlf'), 'no' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.no.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.no.xlf'), 'pl' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.pl.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.pl.xlf'), 'pt' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.pt.xlf'), 'pt_BR' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.pt_BR.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.pt_BR.xlf'), 'ro' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.ro.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.ro.xlf'), 'ru' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.ru.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.ru.xlf'), 'sk' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.sk.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.sk.xlf'), 'sl' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.sl.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.sl.xlf'), 'sq' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.sq.xlf'), 'sr_Cyrl' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.sr_Cyrl.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.sr_Cyrl.xlf'), 'sr_Latn' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.sr_Latn.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.sr_Latn.xlf'), 'sv' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.sv.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.sv.xlf'), 'th' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.th.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.th.xlf'), 'tl' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.tl.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.tl.xlf'), 'tr' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.tr.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.tr.xlf'), 'uk' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.uk.xlf'), 'vi' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.vi.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.vi.xlf'), 'zh_CN' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.zh_CN.xlf', 1 => '/app/vendor/symfony/security/Core/Resources/translations/security.zh_CN.xlf'), 'zh_TW' => array(0 => '/app/vendor/symfony/validator/Resources/translations/validators.zh_TW.xlf'), 'pt_PT' => array(0 => '/app/vendor/symfony/security/Core/Resources/translations/security.pt_PT.xlf'), 'ua' => array(0 => '/app/vendor/symfony/security/Core/Resources/translations/security.ua.xlf'))));
    ...
    {
        return $this->privates['twig.extension.code'] = new \Symfony\Bridge\Twig\Extension\CodeExtension(($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService()), '/app/src', 'UTF-8');
    }
    ...
    {
        $this->privates['twig.loader.native_filesystem'] = $instance = new \Twig\Loader\FilesystemLoader(array(), '/app');

        $instance->addPath('/app/templates');
        $instance->addPath('/app/vendor/symfony/framework-bundle/Resources/views', 'Framework');
        $instance->addPath('/app/vendor/symfony/framework-bundle/Resources/views', '!Framework');
        $instance->addPath('/app/vendor/doctrine/doctrine-bundle/Resources/views', 'Doctrine');
        $instance->addPath('/app/vendor/doctrine/doctrine-bundle/Resources/views', '!Doctrine');
        $instance->addPath('/app/vendor/symfony/security-bundle/Resources/views', 'Security');
        $instance->addPath('/app/vendor/symfony/security-bundle/Resources/views', '!Security');
        $instance->addPath('/app/vendor/symfony/web-profiler-bundle/Resources/views', 'WebProfiler');
        $instance->addPath('/app/vendor/symfony/web-profiler-bundle/Resources/views', '!WebProfiler');
        $instance->addPath('/app/vendor/symfony/twig-bundle/Resources/views', 'Twig');
        $instance->addPath('/app/vendor/symfony/twig-bundle/Resources/views', '!Twig');
        $instance->addPath('/app/vendor/nelmio/api-doc-bundle/Resources/views', 'NelmioApiDoc');
        $instance->addPath('/app/vendor/nelmio/api-doc-bundle/Resources/views', '!NelmioApiDoc');
        $instance->addPath('/app/templates');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles_metadata' => array(
                ...
                'FOSRestBundle' => array(
                    'path' => '/app/vendor/friendsofsymfony/rest-bundle',
            ...
            'hautelook_alice.fixtures_path' => 'Resources/fixtures',
            'hautelook_alice.root_dirs' => array(
                0 => '/app/src',
                1 => '/app',
            ),
            ...
            'console.command.ids' => array(
                ...
                11 => 'hautelook_alice.console.command.doctrine.doctrine_orm_load_data_fixtures_command',
            ),
        );
    }
}
