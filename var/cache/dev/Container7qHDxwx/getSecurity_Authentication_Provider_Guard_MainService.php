...
}, 1), new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($this->services['doctrine'] ?? $this->getDoctrineService()), 'App\\Entity\\User', 'apiKey', NULL), 'main', new \Symfony\Component\Security\Core\User\UserChecker());
